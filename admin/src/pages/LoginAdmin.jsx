...
const LoginAdmin = () => {
    ...
    return (
        <form onSubmit={submitHandler} className='min-h-[80vh] flex items-center'>
            <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 text-sm border rounded-xl shadow-sm text-[#5E5E5E]'>
                ...
                <button className='bg-primary text-white py-2 rounded-md text-base w-full'>Login</button>
                {state === 'Admin' ? (
                    <p>
                        Doctor Login?{' '}
