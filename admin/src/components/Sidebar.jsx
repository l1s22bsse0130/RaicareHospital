            ...
            {aToken && (
                <ul className='text-[#515151] mt-5'>
                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? "bg-[#F2F3FF] border-r-4 border-primary" : ""}`} to={'/admin-dashboard'}>
                        <img className='w-8 h-8 md:w-10 md:h-10' src={assets.home_icon} alt="" />
                    ...
                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? "bg-[#F2F3FF] border-r-4 border-primary" : ""}`} to={'/all-appoinments'}>
                        <img className='w-8 h-8 md:w-10 md:h-10' src={assets.appointment_icon} alt="" />
                        <p className='hidden md:block'>Appoinments</p>
                    </NavLink>
                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? "bg-[#F2F3FF] border-r-4 border-primary" : ""}`} to={'/add-doctor'}>
                        <img className='w-8 h-8 md:w-10 md:h-10' src={assets.add_icon} alt="" />
                    ...
                    <NavLink className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? "bg-[#F2F3FF] border-r-4 border-primary" : ""}`} to={'/doctor-list'}>
                        <img className='w-8 h-8 md:w-10 md:h-10' src={assets.people_icon} alt="" />
